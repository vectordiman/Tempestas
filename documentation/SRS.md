...
Ответом на данный вопрос как раз является данный проект - Tempestas.
 
Tempestas - это мобильное приложение, которое предоставляет все необходимые данные о погоде в удобной и красивой форме.
